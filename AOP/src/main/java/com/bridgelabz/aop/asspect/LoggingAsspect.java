package com.bridgelabz.aop.asspect;
...
public class LoggingAsspect {
	...
	// com.bridgelabz.springaop.model.Circle.getName())" )
	/*
	 * @Before("allGetters() && allCircleMethod()") public void logginAdvice() {
	 * System.out.println("Advice run get method call"); }
	 */
	/*
	 * @Before("allCircleMethod()") public void logginAdvice(JoinPoint joinPoint) {
	 ...
	 * throwingException(String name,RuntimeException ex) {
